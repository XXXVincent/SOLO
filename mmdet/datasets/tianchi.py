...
class TianchiDataset(CustomDataset):
    ...
    CLASSES = ('Children Cabinet', 'Nightstand', 'Bookcase / jewelry Armoire', 'Wardrobe', 'Tea Table',
               ...
               'Drawer Chest / Corner cabinet', 'Shelf', 'Round End Table', 'Double Bed', 'Bunk Bed',
               'Bed Frame', 'Single bed', 'Kids Bed', 'Dining Chair', 'Lounge Chair / Book-chair / Computer Chair',
